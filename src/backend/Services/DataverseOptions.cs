...
public sealed class DataverseOptions
{
    ...
    public string SelectColumns { get; set; } = "cr2ef_fixtureid,cr2ef_matchid,cr2ef_name,cr2ef_hometeam,cr2ef_awayteam,cr2ef_date,cr2ef_prediction,cr2ef_matchstatus,cr2ef_groupname";
